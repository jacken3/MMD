...
train_pipeline = [
    ...
    dict(type='ResizeCropFlipImage', data_aug_conf = ida_aug_conf, training=True), #相对于改变了相机的内参，对图像进行了Aug
    dict(
    ...
    dict(type='GlobalRotScaleTransImage',
            ...
            reverse_angle=True,
            training=True
    ), #改变了Lidar坐标系，对GT进行了Aug,这里其实有关Lidar的所有变换矩阵都应该进行修改
...
optimizer = dict(
    ...
    weight_decay=0.01)  # for 8gpu * 1sample_per_gpu
